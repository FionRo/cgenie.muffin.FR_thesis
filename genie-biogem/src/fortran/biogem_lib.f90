...
MODULE biogem_lib
  ...
  REAL::par_bio_remin_AOM_kSO4                                   ! AOM SO4 half sat constant (mol kg-1)
  NAMELIST /ini_biogem_nml/par_bio_remin_AOM_kSO4
  ...
  INTEGER,PARAMETER::n_diag_bio                           = 18 !
  INTEGER,PARAMETER::n_diag_geochem                       = 09 !
