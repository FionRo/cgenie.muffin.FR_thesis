...
CODEDIR=~/cgenie.muffin_hp_faster
OUTROOT=~/cgenie_output_hp_faster
ARCHIVEDIR=~/cgenie_archive_hp_faster
LOGDIR=~/cgenie_log_hp_faster

RUNTIME_ROOT=${RUNTIME_ROOT:=../../cgenie.muffin_hp_faster}
