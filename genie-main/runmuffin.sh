...
# set home directory
#HOMEDIR=$HOME
HOMEDIR=/Users/frochholz
#####################################################################
# set output directory
OUTPUTDIR=$HOMEDIR/cgenie_output_hp_faster
...
if [ -z "$2" ]; then
    ...
    GOINDIR=$HOMEDIR/cgenie.muffin_hp_faster/genie-userconfigs/"$2"
fi
...
CONFIGPATH=$HOMEDIR/cgenie.muffin_hp_faster/genie-main/configs
CONFIGNAME=$RUNID".config"
BINARYPATH=$HOMEDIR/cgenie.muffin_hp_faster/genie-main
RESTARTNAME="rst.1"
#
# (3) CHECK PARAMETERS
# --------------------------------------
...
mv $RUNID.tar.gz $HOMEDIR/cgenie_archive_hp_faster/$RUNID.tar.gz
cd $BINARYPATH
